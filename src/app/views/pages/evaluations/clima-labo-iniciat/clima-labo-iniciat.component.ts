...
@Component({
  selector: 'kt-clima-labo-iniciat',
  templateUrl: './clima-labo-iniciat.component.html',
  styleUrls: ['./clima-labo-iniciat.component.scss']
})
export class ClimaLaboIniciatComponent implements OnInit {
