...
@Component({
  selector: 'kt-clima-laboral-nue',
  templateUrl: './clima-laboral-nue.component.html',
  styleUrls: ['./clima-laboral-nue.component.scss']
})
export class ClimaLaboralNueComponent implements OnInit {
