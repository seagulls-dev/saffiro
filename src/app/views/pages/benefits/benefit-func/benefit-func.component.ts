...
@Component({
  selector: 'kt-benefit-func',
  templateUrl: './benefit-func.component.html',
  styleUrls: ['./benefit-func.component.scss']
})
export class BenefitFuncComponent implements OnInit {
