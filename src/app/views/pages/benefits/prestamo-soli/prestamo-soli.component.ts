...
@Component({
  selector: 'kt-prestamo-soli',
  templateUrl: './prestamo-soli.component.html',
  styleUrls: ['./prestamo-soli.component.scss']
})
export class PrestamoSoliComponent implements OnInit {
