...
@Component({
  selector: 'kt-new-process-config',
  templateUrl: './new-process-config.component.html',
  styleUrls: ['./new-process-config.component.scss']
})
export class NewProcessConfigComponent implements OnInit {
