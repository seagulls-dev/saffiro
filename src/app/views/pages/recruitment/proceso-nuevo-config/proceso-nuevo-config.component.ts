...
@Component({
  selector: 'kt-proceso-nuevo-config',
  templateUrl: './proceso-nuevo-config.component.html',
  styleUrls: ['./proceso-nuevo-config.component.scss']
})
export class ProcesoNuevoConfigComponent implements OnInit {
