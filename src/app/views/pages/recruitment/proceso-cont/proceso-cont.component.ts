...
@Component({
  selector: 'kt-proceso-cont',
  templateUrl: './proceso-cont.component.html',
  styleUrls: ['./proceso-cont.component.scss']
})
export class ProcesoContComponent implements OnInit {
  ...
  initTableData() {
    this.service.getProcesoCont().subscribe(res => {
      this.KTDatatableModal = function () {

        var subRemoteProcesosContratados = function () {
          var el = $('#tabla-procesos-contratados');
