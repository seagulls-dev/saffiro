...
export class ActiveProcessComponent implements OnInit {
  ...
  initData() {
    this.service.getActiveProcess().subscribe(res => {
      this.KTDatatableModal = function () {
        var subRemoteProcesosActivos = function () {
          var el = $('#tabla-procesos-activos');
            ...
            columns: [
              {
                ...
                template: function (row) {
                  ...
                  return '<a class="asist-com">' + row.nombre_cargo + '</a>';
                },
...
function initEvents() {
  $('#tabla-procesos-activos').on('click', 'table tbody a.asist-com', function() {
    g_router.navigate(['/admin/reclutamiento/asist-com']);
  });
}