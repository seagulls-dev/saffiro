...
@Component({
  selector: 'kt-proceso-cont-cerrados',
  templateUrl: './proceso-cont-cerrados.component.html',
  styleUrls: ['./proceso-cont-cerrados.component.scss']
})
export class ProcesoContCerradosComponent implements OnInit {
  ...
  initTableData() {
    this.service.getProcesoContCerrados().subscribe(res => {
      this.KTDatatableModal = function () {


        var subRemoteProcesosContratadosCerrados = function () {
          var el = $('#tabla-procesos-contratados-cerrados');
        ...
        return {
          ...
          init: function () {
            ...
            subRemoteProcesosContratadosCerrados();
          }
        };
      }();
